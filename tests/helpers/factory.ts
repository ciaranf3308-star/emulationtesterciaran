...
export function makeValidConfig(systems:any[]) {
  return {
    ...
    roots:{ rom: win('D:','Emulation','roms',''), gamelists: win('C:','Users','ciara','AppData','Roaming','EmuDeck'), scrapedMedia: win('C:','Emulation','storage','downloaded_media') },
    systems,
    authoritativeFiles:{ 'es_systems.cfg': win('C:','Users','ciara','AppData','Roaming','EmuDeck','es_systems.cfg') },
    ambiguities:[],
    launchArchitecture:{},
    mediaArchitecture:{},
